...
class MyRejectedVenues extends StatelessWidget {
  const MyRejectedVenues({super.key});
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return buildRejectedVenueCard();
        });
  }

  Widget buildRejectedVenueCard() {
